...
//                   <p className="mt-2 text-muted-foreground">
//                     Monday - Satuarday: 9:00 AM - 5:00 PM<br />
...
//               <div className="mt-8">
//                 <h3 className="mb-1 font-heading text-lg font-medium">Connect With Us</h3>
...
//                 <div className="flex space-x-4">
//   {[
//     { name: "instagram", icon: <FaInstagram width={50} height={50} /> },
//     { name: "linkedin", icon: <FaLinkedin /> },
//   ].map((social) => (
//     <a
//       key={social.name}
//       href="#"
//       className="flex h-10 w-10  bg-black text-white items-center justify-center rounded-full   transition-colors  hover:bg-primary hover:text-primary-foreground"
//     >
...
export default function ContactPage() {
  // Flag to toggle layout based on whether ContactForm is commented out
  const isContactFormEnabled = false; // Set to true when you uncomment ContactForm
  ...
  return (
    <div className="container mx-auto px-4 py-24 pt-32 sm:px-6">
      <div className="mx-auto max-w-5xl">
        ...
        {/* Contact Information and Admission Inquiries Section */}
        <div className={isContactFormEnabled ? "grid gap-12 md:grid-cols-2" : "max-w-xl mx-auto space-y-8"}>
          <div>
            <div className="rounded-lg border border-border bg-card p-6 shadow-lg">
              <h2 className="mb-6 font-heading text-2xl font-semibold">Contact Information</h2>
          ...
          {/* Uncomment the ContactForm when ready */}
          {/* <div>
            <ContactForm />
          </div> */}
        </div>
