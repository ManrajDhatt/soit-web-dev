...
export default function ProgramsPage() {
  return (
    <div className="relative bg-background">
      ...
      {/* Admission Process Section (Fixed and Responsive) */}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-2 bg-primary/20"></div>
              ...
              {[
                ...
                <div key={index} className="relative mb-12 flex flex-col md:flex-row items-center ">
                  {/* Circle with Step Number (Positioned on the Line) */}
                  <div className="absolute left-1/2 transform -translate-x-1/2  z-10 -top-3">
                  ...
                  {/* Content Block */}
                  <div
                    className={`w-full md:w-5/12 ${index % 2 === 0 ? "md:mr-auto" : "md:ml-auto"} px-4`}
                  >
          ...
          <div className="max-w-5xl mx-auto">
                ...
                >
                  <div className="relative h-48">
                    <Image
                      ...
                      className="object-cover transition-transform duration-500 group-hover:scale-110"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100   transition-transform duration-500 group-hover:scale-110" />
                  </div>
            ...
            <div className="mt-8 text-center">
              <Button asChild variant="outline" className="rounded-full">
                <Link href="/about/meet-our-team">View All Faculty</Link>
              </Button>
            </div>
          </div>
        </div>
