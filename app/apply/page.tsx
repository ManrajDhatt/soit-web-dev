...
//           <Image
//             src="/images/apply-hero.jpg" // Replace with an actual hero image
...
//                               <FormControl>
//                                 <Input placeholder="1234567890" {...field} aria-label="Mobile number" />
//                               </FormControl>
//                               <FormMessage />
//                             </FormItem>
//                           )}
...
//                           render={({ field }) => (
//                             <FormItem>
//                               <FormLabel>Alternative Mobile Number (Optional)</FormLabel>
//                               <FormControl>
//                                 <Input
...
//                             <FormControl>
//                               <Input type="date" {...field} aria-label="Date of birth" />
//                             </FormControl>
//                             <FormMessage />
//                           </FormItem>
//                         )}
...
//                         </Select>
//                         <FormDescription>
//                           Select the course you wish to apply for. Courses are grouped by category for easy navigation.
//                         </FormDescription>
//                         <FormMessage />
//                       </FormItem>
//                     )}
...
//                     <div className="mt-4">
//                       <h4 className="text-lg font-medium mb-2">Other Courses in This Category</h4>
...
//                     render={({ field }) => (
//                       <FormItem>
//                         <FormLabel>10th Certificate (PDF)</FormLabel>
//                         <FormControl>
//                           <div className="flex items-center gap-4">
//                             <Button
//                               type="button"
//                               variant="outline"
//                               onClick={() => document.getElementById("tenthCertificateInput")?.click()}
//                               aria-label="Upload 10th certificate"
//                             >
//                               <Upload className="h-4 w-4 mr-2" />
//                               Upload PDF
//                             </Button>
//                             <Input
//                               id="tenthCertificateInput"
//                               type="file"
//                               accept=".pdf"
//                               className="hidden"
//                               onChange={(e) => {
...
//                                   setTenthPreview(URL.createObjectURL(file));
//                                 } else {
//                                   setTenthPreview(null);
//                                 }
//                               }}
...
//                     render={({ field }) => (
//                       <FormItem>
//                         <FormLabel>12th Certificate (PDF)</FormLabel>
//                         <FormControl>
//                           <div className="flex items-center gap-4">
//                             <Button
//                               type="button"
//                               variant="outline"
//                               onClick={() => document.getElementById("twelfthCertificateInput")?.click()}
//                               aria-label="Upload 12th certificate"
//                             >
//                               <Upload className="h-4 w-4 mr-2" />
//                               Upload PDF
//                             </Button>
//                             <Input
//                               id="twelfthCertificateInput"
//                               type="file"
//                               accept=".pdf"
//                               className="hidden"
//                               onChange={(e) => {
...
//                                 field.onChange(file);
//                                 if (file && file.type === "application/pdf") {
//                                   setTwelfthPreview(URL.createObjectURL(file));
//                                 } else {
//                                   setTwelfthPreview(null);
//                                 }
//                               }}
...
//                       render={({ field }) => (
//                         <FormItem>
//                           <FormLabel>Diploma Certificate (PDF)</FormLabel>
//                           <FormControl>
//                             <div className="flex items-center gap-4">
//                               <Button
//                                 type="button"
//                                 variant="outline"
//                                 onClick={() => document.getElementById("diplomaCertificateInput")?.click()}
//                                 aria-label="Upload diploma certificate"
//                               >
//                                 <Upload className="h-4 w-4 mr-2" />
//                                 Upload PDF
//                               </Button>
//                               <Input
//                                 id="diplomaCertificateInput"
//                                 type="file"
//                                 accept=".pdf"
//                                 className="hidden"
//                                 onChange={(e) => {
...
//                 <Button
//                   type="submit"
//                   className="w-full bg-gradient-to-r from-primary to-accent text-lg hover:shadow-lg hover:shadow-accent/20"
...
//           Contact our admissions team for help with your application or to schedule a counseling session.
//         </p>
